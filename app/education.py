...
_MEASUREMENT_CONTENT = {
    ...
    "soil_temperature": ("Soil temperature", "°C", "how warm the soil is near the sensor", "It changes more slowly than air temperature and shows how environmental measurements can lag behind one another.", "One probe represents its immediate depth and location; it does not describe every soil layer."),
    ...
    "soil_ph": ("Soil pH", "", "a scale describing acidity or alkalinity in the sampled soil", "FarmPi records a sensor value so users can examine values and change without treating it as a fertiliser recommendation.", "pH is logarithmic and field interpretation needs sampling, calibration and context beyond this synthetic dataset."),
    ...
    "leaf_wetness": ("Leaf wetness", "%", "a sensor proxy for how wet the leaf surface is", "It shows how rainfall, humidity and light can move together in a synthetic model.", "It does not identify disease or prove a biological outcome."),
}
