...
| `/api/learning/activities` | GET | Teach-by-doing activity catalogue. |
...
`POST /api/ask` accepts a question, optional confirmation/conversation token, optional speech alternatives, and presentation preferences. Its response can contain:
